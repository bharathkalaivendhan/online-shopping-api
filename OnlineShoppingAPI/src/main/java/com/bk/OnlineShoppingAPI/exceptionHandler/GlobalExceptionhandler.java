...
import com.bk.OnlineShoppingAPI.order.OrderNotFoundException;
...
public class GlobalExceptionhandler {
	...
	public ResponseEntity<ErrorInfo> handleOrderNotFoundException(HttpServletRequest req, Exception ex){
		ErrorInfo erroInfo = new ErrorInfo(req.getRequestURI().toString(), ex.getMessage());
		return new ResponseEntity<ErrorInfo>(erroInfo,HttpStatus.NOT_FOUND);
	}
